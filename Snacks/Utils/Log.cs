...
namespace Snack.Utils
{
    public class Log
    {
        ...
        private Log()
        {
            monitoringLogger = log4net.LogManager.GetLogger("MonitoringLogger");
            debugLogger = log4net.LogManager.GetLogger("DebugLogger");
        }
        /// <summary>
       ...
       string pMensaje)
        ...
        MethodBase pMethodBase, ref string pMensaje)
        {
            ...
            msg.AppendFormat("Fecha del Error {0}\n", DateTime.Now.ToString("dd-MM-yyhh: mm:ss"));
